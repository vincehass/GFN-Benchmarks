...
# from sklearn.ensemble.HistGradientBoostingRegressor import loss
...
#         try:
#             regressors.extend([cls for cls in import_module(f'sklearn.{module}').__all__ if 'HistGradientBoostingRegressor' in cls ])
#         except:
#             pass
