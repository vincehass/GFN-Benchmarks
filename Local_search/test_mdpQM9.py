...
from gflownet.MDPs import _blockgraphlists as BGL
from gflownet.MDPs import seqpamdp


class MolStrMDP(seqpamdp.SeqPrependAppendMDP):
  def __init__(self, args):
    blocks_file = args.get('blocks_file', 'datasets/qm9str/block_qm9str_v1.json')
...
def test():
  ...
  print("content of leaf object",x.content)
  print(mol)
